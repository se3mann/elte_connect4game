...
namespace Connect4.ViewModel
{
    ...
    public class Connect4ViewModel : ViewModelBase
    {
        ...
        /// Játéktábla mérete
        /// </summary>
        public Int32 TableSize { get { return _model.Table.TableSize; } }
        ...
        /// <summary>
        /// 5x5 táblaméret lekérdezése.
        /// </summary>
        public Boolean IsTableSize5
        {
            get { return _model.Table.TableSize == 5; }
            set
            {
                if (_model.Table.TableSize == 5)
                    return;

                _model.Table.TableSize = 5;
                OnPropertyChanged("IsTableSize5");
                OnPropertyChanged("IsTableSize7");
                OnPropertyChanged("IsTableSize10");
            }
        }

        /// <summary>
        /// 7x7 táblaméret lekérdezése.
        /// </summary>
        public Boolean IsTableSize7
        {
            get { return _model.Table.TableSize == 7; }
            set
            {
                if (_model.Table.TableSize == 7)
                    return;

                _model.Table.TableSize = 7;
                OnPropertyChanged("IsTableSize5");
                OnPropertyChanged("IsTableSize7");
                OnPropertyChanged("IsTableSize10");
            }
