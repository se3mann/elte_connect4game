...
namespace Connect4.Test
{
    ...
    public class Connect4GameModelTest
    {
        ...
        [TestMethod]
        public void Connect4GameModelNewGame5Test()
        {
            _model.NewGame(5);

            Assert.AreEqual(5, _model.Table.TableSize);
            Assert.AreEqual(Players.Player1, _model.CurrentPlayer);
            Assert.AreEqual(0, _model.Player2Time);
            Assert.IsFalse(_model.IsCurrentPlayerWon());
            ...
            Assert.AreEqual(25, emptyFields);

        }

        [TestMethod]
        public void Connect4GameModelNewGame7Test()
        {
            _model.NewGame(7);

            Assert.AreEqual(7, _model.Table.TableSize);
            Assert.AreEqual(Players.Player1, _model.CurrentPlayer);
            Assert.AreEqual(0, _model.Player2Time);
            Assert.IsFalse(_model.IsCurrentPlayerWon());
            ...
            Assert.AreEqual(49, emptyFields);
