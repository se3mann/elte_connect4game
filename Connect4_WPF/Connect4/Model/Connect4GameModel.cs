...
namespace Connect4.Model
{
    ...
    public class Connect4GameModel
    {
        ...
        /// </summary>
        public event EventHandler<Connect4EventArgs> GameCreated;
        ...
        public void NewGame()
        {
            _table = new Connect4Table(this.Table.TableSize);
            _player1Time = 0;
            _player2Time = 0; 
            _currentPlayer = Players.Player1;
            _currentPlayerWon = false;
        ...
        private void OnGameCreated()
        {
            if(GameCreated != null)
            {
                ...
                GameCreated(this, new Connect4EventArgs(_currentPlayer, currentPlayerTime, false, false));
            }
        }
